# Plugin manager: https://github.com/z-shell/zi
# https://wiki.zshell.dev/docs/guides/syntax/standard
# https://wiki.zshell.dev/docs/guides/syntax/ice-modifiers
...
zi snippet https://github.com/oniony/TMSU/blob/master/misc/zsh/_tmsu
...
zi ice --lucid --wait --as=completion --blockf --has=asdf --mv="asdf.zsh -> _asdf"
zi snippet https://github.com/asdf-vm/asdf/blob/master/internal/completions/asdf.zsh
...
zi ice --lucid --wait --as=completion --blockf --has=bun --mv="just.zsh -> _just"
...
zi ice --wait --lucid --atinit="source ${Plugins[KBROOM_DIR]}/atinit/zsh-history-substring-search.zsh"
