...
awful.layout.layouts = {awful.layout.suit.tile, awful.layout.suit.tile.bottom, awful.layout.suit.fair,
                        awful.layout.suit.magnifier, awful.layout.suit.max}
...
-- {{{ Key bindings
-- Custom
local globalkeys = gears.table.join(awful.key({modkey}, "d", function()
